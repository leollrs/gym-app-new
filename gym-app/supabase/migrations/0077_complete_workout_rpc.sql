-- Single RPC that replaces ~8 client-side DB calls for workout completion.
-- Everything runs in one transaction so it either fully succeeds or fully rolls back.
