-- =============================================================
-- SECURITY FIX: Leaderboard RPCs gym boundary enforcement
-- Migration: 0143_security_fix_leaderboard_rpcs.sql
--
-- 5 leaderboard RPCs from 0088 were missing gym boundary checks:
...
--
-- This adds the same guard used in 0098 for volume/prs,
-- but also allows super_admin to bypass the check.
-- =============================================================
