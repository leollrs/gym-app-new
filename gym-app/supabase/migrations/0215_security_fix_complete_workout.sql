-- Security Fix: Input validation for complete_workout and get_feed_enrichment
-- ================================================================================
-- FIX 1: complete_workout — reject out-of-bounds duration, volume, and long names
-- FIX 2: get_feed_enrichment — cap UUID array length to prevent DoS
-- ================================================================================

-- ── FIX 1: complete_workout — validate input bounds ─────────────────────────────
...
-- ── FIX 2: get_feed_enrichment — cap UUID array length ──────────────────────────
...
BEGIN
  ...
  IF array_length(p_item_ids, 1) > 100 THEN
