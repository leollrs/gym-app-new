-- =============================================================
-- Update get_auth_context() to return additional_roles
-- Migration: 0333_get_auth_context_with_roles.sql
--
-- The AuthContext-shape RPC defined in 0303 doesn't include the new
-- `additional_roles` column added in 0332. The AuthContext needs both
-- `role` (primary) and `additional_roles` (extras) to compute
-- `availableRoles` for the view-switcher UI.
-- =============================================================
