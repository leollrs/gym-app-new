-- =============================================================
-- 0255 — Fix XP cap: use gym_points_config values + PR cap
--
-- Problem: complete_workout still has hardcoded C_PR_XP = 100
-- with no cap. Migration 0254 created gym_points_config with
-- correct defaults (workout 50, PR 20, max 5 PRs) but never
-- wired it into the function.
--
-- Fix: Update the XP section of complete_workout to read from
-- get_gym_points() and enforce pr_max_per_session cap.
-- =============================================================
