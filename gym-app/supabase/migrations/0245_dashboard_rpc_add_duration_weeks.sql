-- Fix get_dashboard_data: restore full original RPC, just add duration_weeks to program select
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    -- Active generated program (not expired) — now includes duration_weeks
    'program', (
