...
import { Dumbbell, ArrowRight, ClipboardList, Scale, Users, Trophy, Sparkles, ChevronRight } from 'lucide-react';
import { supabase } from '../lib/supabase';
import { useAuth } from '../contexts/AuthContext';

// ── Goal-based personalized messages ────────────────────────
const GOAL_MESSAGES = {
  muscle_gain:     { headline: 'Your muscle-building journey starts now', icon: '💪' },
  fat_loss:        { headline: 'Your fat-loss transformation begins today', icon: '🔥' },
  strength:        { headline: 'Time to start lifting heavier', icon: '🏋️' },
  endurance:       { headline: 'Your endurance journey starts here', icon: '🏃' },
  general_fitness: { headline: 'Your path to better fitness starts now', icon: '✨' },
};
        ...
        >
          ...
          <motion.div className="text-center mb-8" variants={scaleIn}>
            ...
            <p className="text-[15px] text-[#9CA3AF]">
              {goalInfo.icon} {goalInfo.headline}
            </p>
          </motion.div>
