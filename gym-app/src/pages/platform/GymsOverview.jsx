          ...
          <div className="bg-[#0F172A] border border-white/6 rounded-xl overflow-hidden">
            ...
            {filtered.map((gym, i) => (
              <button
                ...
                className="w-full text-left grid grid-cols-1 md:grid-cols-[1fr_120px_100px_80px_110px_140px_32px_32px] gap-2 md:gap-4 px-4 py-3.5 border-b border-white/6 last:border-b-0 hover:bg-[#111827] transition-colors group"
              >
                ...
                <div className="flex items-center md:hidden gap-2 flex-wrap">
                  ...
                  <span
                    role="button"
                    tabIndex={0}
                    onClick={(e) => { e.stopPropagation(); e.preventDefault(); setAddMemberGym(gym); }}
                    onKeyDown={(e) => { if (e.key === 'Enter') { e.stopPropagation(); e.preventDefault(); setAddMemberGym(gym); } }}
                    className="flex items-center gap-1 text-[11px] text-[#D4AF37] bg-[#D4AF37]/10 px-2 py-0.5 rounded-full font-medium cursor-pointer hover:bg-[#D4AF37]/20 transition-colors"
                  >
                    <UserPlus size={10} />
                    Add
                  </span>
                ...
                <div className="hidden md:flex items-center justify-end">
                  <span
                    ...
                    onClick={(e) => { e.stopPropagation(); e.preventDefault(); setAddMemberGym(gym); }}
                    onKeyDown={(e) => { if (e.key === 'Enter') { e.stopPropagation(); e.preventDefault(); setAddMemberGym(gym); } }}
                    className="p-1 rounded-md text-[#6B7280] hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 transition-colors cursor-pointer"
                    title="Add member"
                  >
                    <UserPlus size={14} />
                  </span>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#0F172A] border border-white/8 rounded-2xl p-6 max-w-md w-full mx-4 animate-fade-in-up">
        ...
        <p className="text-[12px] text-[#9CA3AF] mb-4">
          Adding to <span className="text-[#E5E7EB] font-medium">{gymName}</span>
        </p>
