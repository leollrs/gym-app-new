    ...
    <div className="px-4 md:px-8 py-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {[
          ...
          return (
            <div key={card.label} className="bg-[#0F172A] rounded-[14px] border border-white/[0.06] p-4">
          ...
          <div className="h-[200px] md:h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={weeklyData}>
                ...
                <Area type="monotone" dataKey="workouts" stroke="#D4AF37" fill="url(#wkGrad)" strokeWidth={2} name="Workouts" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="h-[200px] md:h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={weeklyData}>
                ...
                <Tooltip {...tooltipStyle} formatter={(v) => [`${v.toLocaleString()} lbs`, 'Volume']} />
                <Area type="monotone" dataKey="volume" stroke="#3B82F6" fill="url(#volGrad)" strokeWidth={2} name="Volume" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
            ...
            {selectedClient === 'all' || weightChartData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={weightChartData}>
                  ...
                  <Area type="monotone" dataKey="weight" stroke="#8B5CF6" fill="url(#wtGrad)" strokeWidth={2} />
                </AreaChart>
              </ResponsiveContainer>
            )}
          </div>
