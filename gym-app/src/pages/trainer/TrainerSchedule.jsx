...
export default function TrainerSchedule() {
  ...
  const loadSessions = async () => {
    ...
    const { data } = await supabase
      ...
      .eq('trainer_id', profile.id)
      .gte('scheduled_at', new Date(Date.UTC(weekStart.getFullYear(), weekStart.getMonth(), weekStart.getDate(), 0, 0, 0)).toISOString())
      .lte('scheduled_at', new Date(Date.UTC(weekEnd.getFullYear(), weekEnd.getMonth(), weekEnd.getDate(), 23, 59, 59, 999)).toISOString())
  ...
  return (
    <div className="px-4 md:px-8 py-6 max-w-5xl mx-auto">
      ...
      {weekOffset === 0 && todaySessions.length > 0 && (
        <div className="mb-6 bg-[#0F172A] border border-white/6 rounded-2xl p-4">
