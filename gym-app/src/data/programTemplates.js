...
// ═══ SPECIALTY ════════════════════════════════════════════════════════
{
  ...
  name_es: 'Glúteos y Cadena Posterior',
  description: 'A 12-week glute-focused program designed to build a strong posterior chain. Three phases progress from foundational movement patterns to advanced single-leg and banded work, with hip thrusts programmed every session.',
  description_es: 'Programa enfocado en glúteos de 12 semanas diseñado para construir una cadena posterior fuerte. Tres fases progresan desde patrones de movimiento fundamentales hasta trabajo avanzado unilateral y con bandas.',
...
// ═══ POSTERIOR CHAIN & GLUTE EMPHASIS ═════════════════════════════════════
{
  ...
  name_es: 'Fuerza y Definición',
  description: "Evidence-based compound-focused program with progressive overload. 4 days per week targeting the full body with emphasis on glutes, legs, and back.",
  description_es: 'Programa basado en evidencia enfocado en compuestos con sobrecarga progresiva. 4 días por semana dirigido al cuerpo completo con énfasis en glúteos, piernas y espalda.',
  category: 'Muscle Growth',
  level: 'Beginner',
  daysPerWeek: 4,
  durationWeeks: 10,
...
},
{
  ...
  name: "Upper/Lower — Posterior Focus",
  name_es: 'Superior/Inferior — Enfoque Posterior',
  description: "A balanced upper/lower split with extra posterior chain and glute volume, shoulder emphasis, and moderate-to-high rep ranges for hypertrophy.",
  description_es: 'División superior/inferior equilibrada con volumen extra de cadena posterior y glúteos, énfasis en hombros, y rangos de repeticiones moderados a altos para hipertrofia.',
  category: 'Muscle Growth',
  level: 'Intermediate',
  daysPerWeek: 4,
  durationWeeks: 8,
...
},
{
  ...
  name: "PPL — Glute & Shoulder Emphasis",
  name_es: 'PPL — Énfasis en Glúteos y Hombros',
  description: "A Push/Pull/Legs split run twice per week. Reduced chest volume, extra glute and hamstring work, shoulder emphasis for balanced development. Each muscle hit twice per week.",
  description_es: 'Empuje/Jalón/Piernas ejecutado dos veces por semana. Menor volumen de pecho, más trabajo de glúteos e isquiotibiales, énfasis en hombros para desarrollo equilibrado. Cada músculo trabajado dos veces por semana.',
  category: 'Muscle Growth',
  level: 'Intermediate',
  daysPerWeek: 6,
  durationWeeks: 8,
...
},
{
  ...
  name: 'Glute & Posterior Chain Advanced',
  name_es: 'Glúteos y Cadena Posterior Avanzado',
  description: "Advanced glute-focused programming. Heavier loads, single-leg work, and banded exercises for continued posterior chain development.",
  description_es: 'Programación avanzada enfocada en glúteos. Cargas más pesadas, trabajo unilateral y ejercicios con bandas para mayor desarrollo de cadena posterior.',
  category: 'Glute Building',
  level: 'Intermediate',
  daysPerWeek: 4,
  durationWeeks: 12,
...
},
{
  ...
  name_es: 'Preparación de Competición',
  description: 'A 12-week competition prep program. Progressive volume into a peak week taper. Maintains muscle while cutting, with emphasis on glutes, hamstrings, shoulders, and back.',
  description_es: 'Programa de preparación para competición de 12 semanas. Volumen progresivo hacia una semana pico con taper. Mantiene músculo mientras se corta, con énfasis en glúteos, isquiotibiales, hombros y espalda.',
  category: 'Fat Loss',
  level: 'Advanced',
  daysPerWeek: 5,
  durationWeeks: 12,
